            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <button form="myForm" href="#" class="btn btn-cyan d-none d-md-inline-block"
                            ...
                            <div class="row g-2 align-items-center">
                                ...
                                <form id="myForm" action="{{ route('salesOrder.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-lg-4 mb-3">
                                            ...
                                            <select id="custbody_cfdi_formadepago" name="custbody_cfdi_formadepago"
                                                required>
                                                <option value="" readonly selected hidden>Selecciona una opción
                                                </option>
                                        ...
                                        <div class="col-6 col-lg-4 mb-3">
                                            ...
                                            <select id="custbody_uso_cfdi" name="custbody_uso_cfdi" required>
                                                ...
                                                <option value="12">D01-Honorarios médicos, dentales y gastos
                                                    hospitalarios.
                                                </option>
                                                <option value="13">D02-Gastos médicos por incapacidad o
                                                    discapacidad
                                                </option>
                                                <option value="14">D03-Gastos funerales.</option>
                                                <option value="15">D04-Donativos.</option>
                                                <option value="16">D05-Intereses reales efectivamente pagados por
                                                    créditos
                                                    hipotecarios (casa habitación).</option>
                                                <option value="17">D06-Aportaciones voluntarias al SAR.</option>
                                                <option value="18">D07-Primas por seguros de gastos médicos.
                                                </option>
                                                <option value="19">D08-Gastos de transportación escolar
                                                    obligatoria.
                                                </option>
                                                <option value="20">D09-Depósitos en cuentas para el ahorro, primas
                                                    que
                                                    tengan como
                                                    base planes de pensiones.</option>
                                                <option value="21">D10-Pagos por servicios educativos
                                                    (colegiaturas)
                                                </option>
                                                <option value="1">G01-Adquisición de mercancias</option>
                                                <option value="2">G02-Devoluciones, descuentos o bonificaciones
                                                </option>
                                                <option value="3">G03-Gastos en general</option>
                                                <option value="4">I01-Construcciones</option>
                                                <option value="5">I02-Mobilario y equipo de oficina por
                                                    inversiones</option>
                                                <option value="6">I03-Equipo de transporte</option>
                                                <option value="7">I04-Equipo de computo y accesorios</option>
                                                <option value="8">I05-Dados, troqueles, moldes, matrices y
                                                    herramental
                                                </option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-lg-3 mb-3">
                                            <label for="custbody_nso_notas_de_usuario">Nota para aprobación
                                                especial</label>
        ...
        function addRow() {
            ...
            new TomSelect(`#${itemInputId}`, {
                ...
                load: function(query, callback) {
                    ...
                    // Obtener el valor seleccionado en el select de ubicaciones
                    const locationId = document.getElementById('locations')?.value;
                    // Construir la URL con ambos parámetros
                    const url =
                        `/netsuite/items/search?q=${encodeURIComponent(query)}&location=${encodeURIComponent(locationId || '')}`;
