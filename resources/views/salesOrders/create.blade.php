                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-2 align-items-center">
                                ...
                                <div class="col-3">
                                    <label for="note">Nota de factura</label>

                                    <input type="text" id="memo" name="memo" class="form-control">
                                </div>

                                <div class="col-3">
                                    <label for="note">Nota para aprobación especial</label>

                                    <input type="text" id="custbody_nso_notas_de_usuario"
                                        name="custbody_nso_notas_de_usuario" class="form-control">
                                </div>

                                <div class="col-3">
                                    <label for="note">Clase</label>

                                    <input type="text" class="form-control" value="LLANTAS" disabled>
                                </div>
