...
class MaxMinGeneralMarcaExport implements WithEvents, WithTitle, WithDrawings
{
    protected $service;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A7', "MÁXIMOS Y MÍNIMOS MARCA " . $fecha_ayer);

                //Escribimos los encabezados
                $encabezado = ['MARCA', 'ARTÍCULO', 'DESCRIPCIÓN', $meses['m3'], $meses['m2'], $meses['m1'], $meses['mesActual'], 'TOTAL', 'STOCK', 'MÍNIMO', 'MÁXIMO', 'PEDMIN', 'PED', 'PROM', 'VENTA MES'];
                $sheet->fromArray($encabezado, null, 'A10');

                // **Obtener los datos de la consulta
                $datos = $this->service->obtenerDatos('marca'); // Obtiene el array con 'hoja_1' y 'hoja_2'
                $filas = $datos['hoja_1']; // Accedemos solo a los datos de la hoja 1
