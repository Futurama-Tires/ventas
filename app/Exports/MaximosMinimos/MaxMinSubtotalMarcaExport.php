...
class MaxMinSubtotalMarcaExport implements WithEvents, WithTitle, WithDrawings
{
    protected $service;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A7', "TOTAL MARCA " . $fecha_ayer);

                //Escribimos los encabezados
                $encabezado = ['MARCA', $meses['m3'], $meses['m2'], $meses['m1'], $meses['mesActual'], 'TOTAL', 'STOCK', 'PORCENTAJE'];
                $sheet->fromArray($encabezado, null, 'A10');

                // **Obtener los datos de la consulta
                $datos = $this->service->obtenerDatos('marca'); // Obtiene el array con 'hoja_1' y 'hoja_2'
                $filas = $datos['hoja_2']; // Accedemos solo a los datos de la hoja 1
                $totales = end($filas);
