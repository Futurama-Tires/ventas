...
class HojaGeneralExport implements WithEvents, WithTitle, WithDrawings, WithColumnWidths
{
    protected $datos;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("F11:AG$ultimaFila")->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
