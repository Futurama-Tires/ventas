...
class HojaMotosExport implements WithEvents, WithTitle, WithDrawings, WithColumnWidths
{
    protected $datos;
    ...
    public function __construct(array $datos)
    {
        $this->datos = collect($datos)->filter(function ($item) {
            ...
            return str_contains($app, 'motociclet');
        });
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("A10:AG10")->getFont()->setBold(true);
